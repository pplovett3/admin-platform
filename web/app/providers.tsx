...
export default function Providers({ children }: { children: React.ReactNode }) {
	...
	useEffect(() => {
		...
		if (uiTheme === 'light') {
			root.style.setProperty('--background', '#ECEBF3');
		...
		if (uiTheme === 'light') {
			return {
				...
				token: {
					...
					colorBgBase: '#ECEBF3', // page background
					colorBgLayout: '#ECEBF3',
				...
				components: {
					...
					Menu: {
						itemSelectedBg: '#F1EFFF', // soft lavender highlight
						itemSelectedColor: '#59479C'
					},
					Tabs: {
						itemSelectedColor: '#8568E4',
						inkBarColor: '#8568E4'
					},
					Table: {
						headerBg: '#F5F3FF',
